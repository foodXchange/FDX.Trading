#!/usr/bin/env python3
"""Set all required DNS records including ASUID for root"""
...
def update_dns_records(config):
    ...
    params = {
        ...
        'TTL3': '1800',
        # ASUID TXT record for root
        'HostName4': 'asuid',
        'RecordType4': 'TXT',
        'Address4': '41260bf0bfcf0f62c6509763f8d3773dceb6e1df952696707f2b337da93eec77',
        'TTL4': '1800'
    }
...
def main():
    """Main function"""
    print("FDX.TRADING DNS UPDATE - All Records with ASUID")
    print("=" * 50)
    ...
    print("  - asuid.www -> TXT -> 41260bf0...ec77")
    print("  - asuid -> TXT -> 41260bf0...ec77")
    ...
    if update_dns_records(config):
        ...
        if records:
            ...
            for record in records:
                addr = record['Address']
                if len(addr) > 50:
                    addr = addr[:20] + "..." + addr[-10:]
                print(f"  {record['Name']}: {record['Type']} -> {addr}")
    else:
