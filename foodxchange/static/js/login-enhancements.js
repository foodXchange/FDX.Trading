// Progressive enhancement for login page

document.addEventListener('DOMContentLoaded', function() {
    // Add social login buttons with progressive enhancement
    const socialContainer = document.querySelector('.social-login');
    if (socialContainer && socialContainer.children.length === 0) {
        socialContainer.innerHTML = `
            ...
            <a href="#" class="social-btn microsoft" onclick="socialLogin('microsoft')">
                <svg class="social-icon" viewBox="0 0 24 24">
...
function socialLogin(provider) {
    // Simulate social login - replace with actual OAuth integration
